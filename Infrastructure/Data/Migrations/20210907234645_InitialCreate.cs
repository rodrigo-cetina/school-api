        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_Careers_CareerId",
                        column: x => x.CareerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScoreRecords_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ScoreRecords_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_CareerId_SubjectId_Code",
                table: "Groups",
                columns: new[] { "CareerId", "SubjectId", "Code" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScoreRecords_GroupId",
                table: "ScoreRecords",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_ScoreRecords_StudentId_GroupId",
                table: "ScoreRecords",
